											...
											<c:forEach items="${cart}" var="entry" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%"><fmt:formatNumber value="${entry.key.nowprice*entry.value}" type="currency" pattern=".00"/></td>
														<td width="10%">
												...
												<fmt:formatNumber value="${total+entry.key.nowprice*entry.value}" type="currency" pattern=".00" var="total"/>
												<%-- <c:set value="${total+entry.key.nowprice*entry.value}" var="total" /> --%>
											</c:forEach>
