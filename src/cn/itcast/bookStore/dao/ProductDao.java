...
public class ProductDao {
	...
	// 多条件查询
		public List<Product> findProductByManyConditions(int currentPage,int currentCount,String name,String category, String minprice, String maxprice)
				throws SQLException {
			List<Object> list = new ArrayList<Object>();
			String sql = "select * from products where 1=1 ";
